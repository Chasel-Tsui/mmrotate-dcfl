...
class DenseAssigner(BaseAssigner):
    ...
    def assign(self, cls_scores, bbox_preds, bboxes, gt_bboxes, gt_bboxes_ignore=None, gt_labels=None):
        ...
        '''
        # the original ranking-based assigner    
        ...
        assign_result =self.dense_assign_wrt_ranking(overlaps, pos_num, gt_labels)
    ...
    def dense_assign_wrt_ranking(self, overlaps, pos_num, gt_labels=None):
